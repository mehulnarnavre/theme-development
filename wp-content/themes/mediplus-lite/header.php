					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-7 col-12">
							...
							<ul class="top-contact">
								<li><i class="fa fa-phone"></i><?php the_field('mobile_no',10); ?></li>
								<li><i class="fa fa-envelope"></i><a href="mailto:support@yourmail.com"><?php the_field('email',10); ?></a></li>
							</ul>
							<!-- End Top Contact -->
						</div>
					</div>
					...
					<div class="inner">
						<div class="row">
							...
							<div class="col-lg-2 col-12">
								<div class="get-quote">
									<a href="<?php echo get_template_directory_uri(); ?>/appointment.html" class="btn">Book Appointment</a>
								</div>
							</div>
						</div>
					</div>
